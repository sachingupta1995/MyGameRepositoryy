...
public class PlayAfterChallengingActivity extends Activity implements ConnectionRequestListener, RoomRequestListener, NotifyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            listQuestions = RetrievingData.getData(getResources().getString(R.string.server_url) + "/initiateGame/level/1", jsonFormatt);
        } catch (IOException e) {
            e.printStackTrace();
        }
        mScore = 0;
